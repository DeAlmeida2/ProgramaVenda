...
namespace ProgramaVenda {
    ...
    public partial class EstoqueDataSet : global::System.Data.DataSet {
        ...
        public partial class clienteDataTable : global::System.Data.TypedTableBase<clienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public clienteRow AddclienteRow(int Id_cliente, string Cpf, string Nome, string Telefone, string Email) {
...
namespace ProgramaVenda.EstoqueDataSetTableAdapters {
    ...
    public partial class clienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[cliente] ([Id_cliente], [Cpf], [Nome], [Telefone], [Email]) VA" +
                "LUES (@Id_cliente, @Cpf, @Nome, @Telefone, @Email);\r\nSELECT Id_cliente, Cpf, Nom" +
                "e, Telefone, Email FROM cliente WHERE (Id_cliente = @Id_cliente)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[cliente] SET [Id_cliente] = @Id_cliente, [Cpf] = @Cpf, [Nome] = @Nome, [Telefone] = @Telefone, [Email] = @Email WHERE (([Id_cliente] = @Original_Id_cliente) AND ((@IsNull_Cpf = 1 AND [Cpf] IS NULL) OR ([Cpf] = @Original_Cpf)) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT Id_cliente, Cpf, Nome, Telefone, Email FROM cliente WHERE (Id_cliente = @Id_cliente)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id_cliente, Cpf, Nome, Telefone, Email FROM dbo.cliente";
        ...
        public virtual int Fill(EstoqueDataSet.clienteDataTable dataTable) {
        ...
        public virtual EstoqueDataSet.clienteDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EstoqueDataSet.clienteDataTable dataTable = new EstoqueDataSet.clienteDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EstoqueDataSet.clienteDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id_cliente, string Original_Cpf, string Original_Nome, string Original_Telefone, string Original_Email) {
        ...
        public virtual int Insert(int Id_cliente, string Cpf, string Nome, string Telefone, string Email) {
        ...
        public virtual int Update(int Id_cliente, string Cpf, string Nome, string Telefone, string Email, int Original_Id_cliente, string Original_Cpf, string Original_Nome, string Original_Telefone, string Original_Email) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Cpf, string Nome, string Telefone, string Email, int Original_Id_cliente, string Original_Cpf, string Original_Nome, string Original_Telefone, string Original_Email) {
            return this.Update(Original_Id_cliente, Cpf, Nome, Telefone, Email, Original_Id_cliente, Original_Cpf, Original_Nome, Original_Telefone, Original_Email);
        }
    }
